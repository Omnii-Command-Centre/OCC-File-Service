      ...
      <div className="p-8 max-w-4xl">
        ...
        <div className="mt-8 bg-dark-2 rounded-xl border border-dark-4 p-5">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-dark-3">
              ...
              <div>
                ...
                <p className="text-xs text-surface-500">
                  Go to github.com/orgs/Surpassin/people &rarr; Invite member &rarr; enter the email and set role to Owner
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-dark-3">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-dark-3">
              <span className="text-lg mt-0.5">
                <svg className="w-5 h-5 text-surface-300" viewBox="0 0 24 24" fill="currentColor"><path d="M18.72 3.99997H5.37C5.19793 3.99191 5.02595 4.01786 4.86392 4.07635C4.70189 4.13484 4.55299 4.22471 4.42573 4.34081C4.29848 4.45692 4.19537 4.59699 4.12232 4.75299C4.04927 4.909 4.0077 5.07788 4 5.24997V18.63C4.01008 18.9943 4.15766 19.3429 4.41243 19.6062C4.6672 19.8694 5.01026 20.0283 5.37 20.05H18.72C19.0793 20.0292 19.4223 19.871 19.6773 19.6083C19.9322 19.3455 20.0803 18.9975 20.091 18.633V5.24997C20.0801 4.88544 19.9318 4.5378 19.6764 4.27534C19.421 4.01289 19.0728 3.86526 18.709 3.84497L18.72 3.99997ZM9 17.34H6.67V10.21H9V17.34ZM7.89 9.12997C7.72741 9.13564 7.5654 9.10762 7.41416 9.04768C7.26291 8.98774 7.12569 8.89717 7.01113 8.78166C6.89## 8.66616 6.80544 8.52813 6.74666 8.37647C6.68789 8.22481 6.66119 8.06274 6.668 7.89997C6.66119 7.73721 6.68789 7.57514 6.74666 7.42348C6.80544 7.27182 6.89657 7.13379 7.01113 7.01829C7.12569 6.90278 7.26291 6.81221 7.41416 6.75227C7.5654 6.69233 7.72741 6.66431 7.89 6.66997C8.05259 6.66431 8.2146 6.69233 8.36584 6.75227C8.51709 6.81221 8.65431 6.90278 8.76887 7.01829C8.88343 7.13379 8.97456 7.27182 9.03334 7.42348C9.09211 7.57514 9.11881 7.73721 9.112 7.89997C9.11881 8.06274 9.09211 8.22481 9.03334 8.37647C8.97456 8.52813 8.88343 8.66616 8.76887 8.78166C8.65431 8.89717 8.51709 8.98774 8.36584 9.04768C8.2146 9.10762 8.05259 9.13564 7.89 9.12997ZM17.34 17.34H15V13.44C15 12.51 14.67 11.87 13.84 11.87C13.5822 11.8722 13.3313 11.9541 13.1219 12.1045C12.9## 12.2549 12.7616 12.4664 12.64 12.71C12.5641 12.8926 12.5275 13.0898 12.5325 13.288V17.34H10.21V10.21H12.5325V11.21C12.7588 10.8286 13.0832 10.5138 13.4726 10.2975C13.862 10.0813 14.3023 9.97132 14.75 9.97997C16.25 9.97997 17.34 10.95 17.34 13.18V17.34Z"/></svg>
              </span>
              <div>
